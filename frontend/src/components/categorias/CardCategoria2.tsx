        ...
        <section className="flex flex-col justify-center items-center flex-wrap gap-3 mt-5 p-4">
            ...
            <div className="card w-[85%] border-double border-4 border-stone-700 flex flex-col gap-2">
                <div className="card-body p-2">
                    <img className="w-full h-40" src="https://cdn.pixabay.com/photo/2021/02/06/19/29/pancakes-5989136_1280.jpg" alt="Imagen de los platos" />
            ...
            <div className="card w-[85%]  border-double border-4 border-stone-700 flex flex-col gap-2">
                <div className="card-body p-2">
                    <img className="w-full h-40" src="https://cdn.pixabay.com/photo/2020/02/01/06/13/vegan-4809593_1280.jpg" alt="Imagen de los platos" />
                    <h5 className="card-title text-xl font-bold text-slate-700  text-center pt-3 lg:text-2xl">Nombre del plato</h5>
                    <p className="text-end text-slate-700 text-lg font-semibold pt-3 lg:text-2xl">$100.00</p>
            ...
            <div className="card w-[85%]  border-double border-4 border-stone-700 flex flex-col gap-2">
                <div className="card-body p-2">
                    <img className="w-full h-40" src="https://cdn.pixabay.com/photo/2014/10/19/20/59/hamburger-494706_1280.jpg" alt="Imagen de los platos" />
                    <h5 className="card-title text-xl font-bold text-slate-700  text-center pt-3 lg:text-2xl">Nombre del plato</h5>
                    <p className="text-end text-slate-700 text-lg font-semibold pt-3 lg:text-2xl">$100.00</p>
